...
const ArticleCard = ({ article }) => {
    return (
        <div
            className="w-[404px] h-[416px] relative text-white flex flex-col flex-wrap bg-cover bg-center 
             after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-full after:h-1/2 
             after:bg-gradient-to-t after:from-black after:to-transparent after:z-0"
            style={{ backgroundImage: `url(${article.image})` }}
        >
            <div className="absolute top-2 left-2 z-10">
                <p className="flex flex-col border px-4 py-1">
                    <span>23</span>
                    <span>JUL</span>
                </p>
            </div>
